...
export default function MonacoEditorWrapper() {
  ...
  const handleEditorDidMount = (editor, monaco) => {
    ...
    // Define Monaco themes for 6 developer themes (including GitHub Light)
    const themesConfig = {
      'tokyo-night': { base: 'vs-dark', bg: '#1a1b26', line: '#16161e', kw: '#bb9af7', str: '#9ece6a', num: '#e0af68', lineNum: '#565f89', activeLineNum: '#7dcfff' },
      'dracula': { base: 'vs-dark', bg: '#282a36', line: '#21222c', kw: '#ff79c6', str: '#50fa7b', num: '#bd93f9', lineNum: '#6272a4', activeLineNum: '#bd93f9' },
      'one-dark': { base: 'vs-dark', bg: '#282c34', line: '#21252b', kw: '#c678dd', str: '#98c379', num: '#d19a66', lineNum: '#5c6370', activeLineNum: '#61afef' },
      'github-dark': { base: 'vs-dark', bg: '#0d1117', line: '#161b22', kw: '#ff7b72', str: '#a5d6ff', num: '#79c0ff', lineNum: '#484f58', activeLineNum: '#58a6ff' },
      'synthwave': { base: 'vs-dark', bg: '#241b2f', line: '#1a1423', kw: '#ff7edb', str: '#72f1b8', num: '#feef6d', lineNum: '#614d69', activeLineNum: '#36f9f6' },
      'github-light': { base: 'vs', bg: '#ffffff', line: '#f6f8fa', kw: '#cf222e', str: '#0a3069', num: '#0550ae', lineNum: '#8c959f', activeLineNum: '#0969da' }
    };
